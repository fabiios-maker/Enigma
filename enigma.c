...
int main(void) {
    ...
    Sala *hall = criarSala("Hall de Entrada", "Pegada de lama estranha");
    Sala *salaEstar = criarSala("Sala de Estar", "Carta rasgada com iniciais 'M.R.'");
    Sala *cozinha = criarSala("Cozinha", "Marca de queimadura no fogão");
    Sala *biblioteca = criarSala("Biblioteca", "Livro aberto na página 237");
    Sala *jardim = criarSala("Jardim", NULL); // sem pista
    Sala *porao = criarSala("Porão", "Pequeno pedaço de tecido vermelho");
    Sala *quarto = criarSala("Quarto Principal", "Anel com monograma");
    Sala *escritorio = criarSala("Escritório", "Bilhete: 'Encontro às 22h'");
    ...
    // Após sair, exibir todas as pistas coletadas em ordem alfabética
